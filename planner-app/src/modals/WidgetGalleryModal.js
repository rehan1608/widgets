...
export default function WidgetGalleryModal({ setShowWidgetModal, selectedWidgetArea, widgets, setWidgets }) {
  const [galleryWidgets, setGalleryWidgets] = useState([
    ...
    { component: <WeatherWidget />, name: 'Weather' }, // Custom widget: WeatherWidget
    { component: <StopwatchWidget />, name: 'Stopwatch' }, // Custom widget: StopwatchWidget
    { component: <TicTacToeGame />, name: 'Tic Tac Toe' }, // Custom widget: TicTacToeGame
    { component: <PhotoWidget />, name: 'Photo' }, // Custom widget: PhotoWidget
    { component: <LocationWidget />, name: 'Location' }, // Custom widget: LocationWidget
  ]);
  return (
    <div className="modal"
      onClick={(e) => {
